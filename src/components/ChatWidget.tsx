              ...
              <div className="space-y-3">
                <div className="bg-slate-dark/60 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[85%] border border-white/5">
                  <p className="text-sm text-white-soft/90 leading-relaxed">
                    Hi! I&apos;m the Solynta Talent AI assistant. I can help you
                    understand our services, pricing, and how we can run your
                    entire back office with AI. What would you like to know?
                  </p>
                </div>
