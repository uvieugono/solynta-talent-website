...
export const MODULES: ModuleDefinition[] = [
  {
    ...
    icon: '💰',
    name: 'Finance Core',
    desc: 'Bookkeeper · Accountant · Payroll Officer · Tax Accountant',
    tiers: true,
    ...
    tierDetails: {
      entry: {
        ...
        subtitle: 'For early-stage businesses (weekly batch processing)',
        roles: 'Bookkeeper & Accountant · Email support (48hr SLA)',
        features: [
          'Weekly batch posting & categorisation (The Friday Sync)',
      ...
      growth: {
        name: 'Finance Growth',
        subtitle: 'For growing businesses (daily processing + WhatsApp receipts)',
        roles: 'Bookkeeper + Accountant + Payroll Officer · WhatsApp receipts included',
        popular: true,
        features: [
          'Everything in Essentials, plus daily processing:',
      ...
      enterprise: {
        name: 'Finance Pro',
        subtitle: 'Full outsourced finance dept (continuous processing)',
        roles: 'All 4 roles · Dedicated Senior Finance Specialist included',
        features: [
          'Everything in Growth, plus near-real-time:',
  ...
  },
  {
    ...
    tierDetails: {
      entry: {
        ...
        features: [
          'Social media content creation & posting (3 platforms)',
