# Homepage FAQ Section Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a comprehensive 50-question FAQ section to the Solynta Talent homepage with category tabs and accordion UI.

**Architecture:** Single `FAQ.tsx` client component with inline data, category tab filtering, and accordion expand/collapse. Placed between WhySolynta and Contact on the homepage. Navbar updated with FAQ anchor link.

**Tech Stack:** Next.js 16, React 19, TypeScript, Tailwind CSS 4, existing ScrollReveal component.

**Spec:** `docs/superpowers/specs/2026-03-16-homepage-faq-design.md`
...
|------|--------|----------------|
| `src/components/FAQ.tsx` | **Create** | All FAQ data, category tabs, accordion UI, animations |
| `src/app/page.tsx` | **Modify** | Import FAQ, place between WhySolynta and Contact |
| `src/components/Navbar.tsx` | **Modify** | Add "FAQ" link to navigation array |

---

## Task 1: Create the FAQ component

**Files:**
- Create: `src/components/FAQ.tsx`

This is the bulk of the work — a single self-contained component with all 50 questions inline.

- [ ] **Step 1: Create `src/components/FAQ.tsx` with full implementation**

The component includes:
- All FAQ data (10 categories, 50 questions)
- Category tab navigation (horizontally scrollable on mobile)
- Accordion with single-open behavior per category
- ScrollReveal animations matching existing site patterns
- `id="faq"` anchor for navbar linking
...
Run: `ls src/components/FAQ.tsx` (from the solynta-talent-website directory)
...
git commit -m "feat: add FAQ component with 50 questions across 10 categories"
```

---

## Task 2: Add FAQ to the homepage

**Files:**
- Modify: `src/app/page.tsx`

- [ ] **Step 1: Add FAQ import and place between WhySolynta and Contact**
...
And place `<FAQ />` between `<WhySolynta />` and `<Contact />`:
```tsx
<WhySolynta />
<FAQ />
<Contact />
...
git commit -m "feat: add FAQ section to homepage between WhySolynta and Contact"
```

---

## Task 3: Add FAQ link to Navbar

**Files:**
- Modify: `src/components/Navbar.tsx:6-13`

- [ ] **Step 1: Add FAQ to the links array**

In `src/components/Navbar.tsx`, add a new entry to the `links` array after "How It Works":
...
git commit -m "feat: add FAQ link to navbar navigation"
```
...
Run: `cd /c/Users/pc/OneDrive/Desktop/Desktop/solynta-talent-website && npm run dev`

Verify in browser at `http://localhost:3000`:
1. FAQ section appears between "Why Solynta Talent" and "Contact" sections
2. Category tabs are visible and clickable — switching tabs changes the questions
3. Accordion opens/closes smoothly with chevron rotation
4. Only one accordion item open at a time; switching categories closes the open item
5. ScrollReveal animations trigger on scroll
6. Navbar "FAQ" link scrolls to the FAQ section
7. Mobile: tabs scroll horizontally, accordion works on touch
...
```bash
git add -A
git commit -m "fix: address FAQ visual verification issues"
```
